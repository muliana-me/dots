...
static const char dmenufont[]       = "FiraCode-Medium:size=10";
static const char col_gray1[]       = "#222222";
static const char col_gray2[]       = "#444444";
static const char col_gray3[]       = "#bbbbbb";
static const char col_gray4[]       = "#eeeeee";
static const char col_cyan[]        = "#005577";
static const char col_whitecustom[] = "#e4e4e4";
static const char col_blackcustom[] = "#1e1e1e";
static const char col_graycustom[]  = "#3a3a3a";
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { col_whitecustom, col_blackcustom, col_blackcustom },
	[SchemeSel]  = { col_whitecustom, col_graycustom,  col_graycustom },
};
...
static const char *screenshot[]     = { "scrot", "screenshot-%Y-%m-%d-%s.png", "-e", "mv $f ~/pictures/", NULL };
static const char *screenshot1[]    = { "scrot", "-s", "screenshot-%Y-%m-%d-%s.png", "-e", "mv $f ~/pictures/", NULL };
static const char *browser[]        = { "chromium", NULL };

static const Key keys[] = {
	/* modifier                     key        function        argument */
	{ MODKEY,			XK_Escape, spawn,	   {.v = shutdown } },
	{ MODKEY,			XK_grave,  spawn,	   {.v = restart } },
	...
	{ MODKEY,			XK_Print,  spawn,	   {.v = screenshot1 } },
